...
<div class="max-w-3xl mx-auto">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">WhatsApp Broadcast</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-orange-50 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-bold text-gray-800">Kirim Pesan WhatsApp</h2>
                <p class="text-xs text-gray-500">Kirim informasi akademik ke orang tua/wali siswa.</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('whatsapp.send') }}">
                ...
                <div class="mb-6">
                    ...
                    <select name="tipe" id="tipe" onchange="toggleForm()" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm transition">
                        <option value="semua">Semua Wali Siswa</option>
