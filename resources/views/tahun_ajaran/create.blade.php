...
<div class="max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-orange-50">
            ...
            <p class="text-xs text-gray-500">Masukkan detail periode akademik baru.</p>
        </div>
        ...
        <div class="p-6">
            <form action="{{ route('tahun_ajaran.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm transition" required value="{{ old('nama') }}" placeholder="Contoh: 2023/2024">
                ...
                <div class="mb-8">
                    <div class="flex items-start">
                        <div class="flex h-5 items-center">
                            <input id="aktif" name="aktif" type="checkbox" value="1" {{ old('aktif') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-orange-600 focus:ring-orange-500">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="aktif" class="font-medium text-gray-700">Jadikan Aktif</label>
                            <p class="text-gray-500">Mengaktifkan tahun ajaran ini akan menonaktifkan tahun ajaran lainnya.</p>
                        </div>
                    </div>
                </div>
