...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-orange-50">
            ...
            <p class="text-xs text-gray-500">Masukkan data siswa dengan lengkap.</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('siswa.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-6">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin')=='L' ? 'checked' : '' }} required class="text-orange-600 focus:ring-orange-500 border-gray-300">
                            <span class="ml-2 text-sm text-gray-700">Laki-laki</span>
                        </label>
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin')=='P' ? 'checked' : '' }} class="text-orange-600 focus:ring-orange-500 border-gray-300">
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Klik input di atas lalu scan kartu RFID siswa.</p>
